...
export default function PackageCard({
    ...
    return (
        <Link href={`/packages/${pkg.id}`} className="flex flex-col h-full group">
            <div
                className="flex flex-col h-full bg-transparent overflow-hidden group-hover:-translate-y-1 transition-all duration-300"
            >
                ...
                <div className="flex flex-col flex-grow pt-4">
                    ...
                    <p className="font-serif text-base text-[#3D0004]/70 leading-relaxed font-light mb-6 flex-grow line-clamp-2 sm:line-clamp-3">
                        {pkg.content}
                    </p>
                    ...
                    <div className="mt-auto pt-2">
                        <button
                            ...
                            className="font-serif text-xs uppercase tracking-wider text-[#680007] group-hover:text-[#b38e5d] transition-colors font-medium inline-flex items-center gap-1 cursor-pointer"
                        >
                            Enquire Now
