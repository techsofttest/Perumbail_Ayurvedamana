...
async function getSEO(slug: string): Promise<SeoPayload> {
    ...
    const res = await fetch(`${baseUrl}/packages/${slug}`, {
        cache: "no-store",
    });
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    return {
        title: seo.meta_title || "Ayurvedamana Package",
        description: seo.meta_desc || "View details about this Ayurvedamana package.",
